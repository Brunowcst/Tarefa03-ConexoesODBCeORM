...
class Funcionario(BaseModel):
    ...
    supervisor = ForeignKeyField('self', backref='subordinados', null=True, on_delete='SET_NULL', on_update='CASCADE')
    depto = ForeignKeyField('Departamento', backref='funcionarios', null=True, on_delete='SET_NULL', on_update='CASCADE')
...
if __name__ == '__main__':
    db.connect()
    db.create_tables([Funcionario, Departamento, Equipe, Projeto, Atividade, AtividadeProjeto, AtividadeMembro])
    db.close()
